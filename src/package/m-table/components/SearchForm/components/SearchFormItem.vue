...
// _Computed 判断 fieldNames 设置 label && value && children 的 key 值
...
// _Computed 接收 enumMap (el 为 select-v2 需单独处理 enumData)
...
// _Computed 处理透传的 searchProps (el 为 tree-select、cascader 的时候需要给下默认 label && value && children)
...
// _Computed 是否有清除按钮 (当搜索项有默认值时，清除按钮不显示)
