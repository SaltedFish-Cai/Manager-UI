...
export interface SiteData<ThemeConfig = any> {
  ...
  description: string;
  head: HeadConfig[];
  appearance: boolean | "dark" | "force-auto" | "force-dark" | (Omit<UseDarkOptions, "initialValue"> & { initialValue?: "dark" });
  themeConfig: ThemeConfig;
  scrollOffset: string[] | number | string | { selector: string[] | string; padding: number };
...
export type HeadConfig = [string, Record<string, string>, string] | [string, Record<string, string>];
